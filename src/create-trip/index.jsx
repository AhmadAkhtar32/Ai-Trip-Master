...
const CreateTrip = () => {
  ...
  return (
    <div className="relative flex flex-col justify-center items-center bg-gradient-to-b from-blue-100 to-gray-100 min-h-screen py-8 px-4">
      {/* Background Video */}
      <video
        autoPlay
        loop
      ...
      >
        <source src="/src/Video/2.mp4" type="video/mp4" />
      ...
      <div className="relative z-10 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col w-full max-w-2xl mb-8">
          <h2 className="text-xl white my-3 font-medium ">
